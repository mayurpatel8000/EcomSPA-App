    ...
    var _ = ["input", "select", "textarea", "a[href]", "button", "[tabindex]:not(slot)", "audio[controls]", "video[controls]", '[contenteditable]:not([contenteditable="false"])', "details>summary:first-of-type", "details"],
        ...
        de = function (e) {
            ...
            var t = e.form || B(e),
                ...
                n;
            if (typeof window < "u" && typeof window.CSS < "u" && typeof window.CSS.escape == "function") n = a(window.CSS.escape(e.name));
            else
                try {
                    n = a(e.name);
                } catch (s) {
        ...
        me = function i(e) {
            ...
            return (e.forEach(function (n, r) {
                    ...
                    m === 0 ? (s ? t.push.apply(t, p) : t.push(l)) : a.push({ documentOrder: r, tabIndex: m, item: n, isScope: s, content: p });
                }),
                a
                    .sort(se)
                    .reduce(function (n, r) {
        ...
        z = function (e, t) {
            t = t || {};
            var a;
            return t.getShadowRoot ? (a = $([e], t.includeContainer, { filter: G.bind(null, t), flatten: !1, getShadowRoot: t.getShadowRoot, shadowRootFilter: ge })) : (a = V(e, t.includeContainer, G.bind(null, t))), me(a);
        },
        x = function (e, t) {
            t = t || {};
            var a;
            return t.getShadowRoot ? (a = $([e], t.includeContainer, { filter: I.bind(null, t), flatten: !0, getShadowRoot: t.getShadowRoot })) : (a = V(e, t.includeContainer, I.bind(null, t))), a;
        },
        A = function (e, t) {
    ...
    var J = (function () {
        ...
        re = function (e, t) {
            var a = t?.document || document,
                ...
                r = { containers: [], containerGroups: [], tabbableGroups: [], nodeFocusedBeforeActivation: null, mostRecentlyFocusedNode: null, active: !1, paused: !1, delayInitialFocusTimer: void 0 },
                s,
                l = function (o, u, c) {
                ...
                T = function (o) {
                    ...
                    if (r.tabbableGroups.length > 0) {
                        ...
                        if (b < 0) o.shiftKey ? (c = r.tabbableGroups[r.tabbableGroups.length - 1].lastTabbableNode) : (c = r.tabbableGroups[0].firstTabbableNode);
                        else if (o.shiftKey) {
                ...
                U = function () {
                    if (r.active)
                        return (
                            a.removeEventListener("focusin", D, !0), a.removeEventListener("mousedown", S, !0), a.removeEventListener("touchstart", S, !0), a.removeEventListener("click", q, !0), a.removeEventListener("keydown", M, !0), s
                        );
                };
            return (
                (s = {
                    ...
                    deactivate: function (o) {
                        if (!r.active) return this;
                        var u = X({ onDeactivate: n.onDeactivate, onPostDeactivate: n.onPostDeactivate, checkCanReturnFocus: n.checkCanReturnFocus }, o);
